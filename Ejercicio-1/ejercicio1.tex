...
\begin{center}
\includegraphics[scale=0.6]{moore1.png}
\end{center}
y la m\'aquina de estados de Mealy queda de la siguiente forma:
\begin{center}
\includegraphics{mealy1.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.75]{moore3.png}
\end{center}
Al simular el circuito en GTKWave se obtiene lo siguiente:
\begin{center}
\includegraphics[scale=0.5]{moore2.png}
\end{center}
Circuito utilizando la m\'aquina de estados de Mealy:
\begin{center}
\includegraphics[scale=0.6]{mealy3.png}
\end{center}
Al simular el circuito en GTKWave se obtiene lo siguiente:
\begin{center}
